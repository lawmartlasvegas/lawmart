...
Google Analytics is enabled site-wide through `site-config.js` using measurement ID `G-43CBCXFRX3`.
The existing site scripts load `gtag.js` and track page views plus supported phone, email, WhatsApp, and lead events. Do not add the Google Tag Manager snippets unless you intentionally migrate tracking later.
