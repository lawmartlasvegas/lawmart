(() => {
  ...
  const smsMessage=(()=>{const path=location.pathname;if(path.includes('peticao-familiar'))return 'Ol\u00e1, tenho interesse no servi\u00e7o de prepara\u00e7\u00e3o de documentos para peti\u00e7\u00e3o familiar.';if(path.includes('ajuste-de-status'))return 'Ol\u00e1, tenho interesse no servi\u00e7o de prepara\u00e7\u00e3o de documentos para ajuste de status.';if(path.includes('naturalizacao'))return 'Ol\u00e1, tenho interesse no servi\u00e7o de prepara\u00e7\u00e3o de documentos para naturaliza\u00e7\u00e3o.';if(path.includes('autorizacao-de-trabalho'))return 'Ol\u00e1, tenho interesse no servi\u00e7o de prepara\u00e7\u00e3o de documentos para autoriza\u00e7\u00e3o de trabalho.';if(path.includes('green-card'))return 'Ol\u00e1, tenho interesse no servi\u00e7o de prepara\u00e7\u00e3o de documentos para renova\u00e7\u00e3o do Green Card.';return 'Ol\u00e1, gostaria de informa\u00e7\u00f5es sobre os servi\u00e7os de prepara\u00e7\u00e3o de documentos da Imigra\u00e7\u00e3o Brasileira.'})();
  if(!document.querySelector('.sms-float')){const sms=document.createElement('a');const separator=/iPad|iPhone|iPod/.test(navigator.userAgent)?'&':'?';sms.className='sms-float';sms.href=`sms:+17029001003${separator}body=${encodeURIComponent(smsMessage)}`;sms.textContent='Enviar SMS';sms.setAttribute('aria-label',`Enviar SMS: ${smsMessage}`);document.body.appendChild(sms)}
